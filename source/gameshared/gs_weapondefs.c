...
#define WEAPONDOWN_FRAMETIME 100
#define WEAPONUP_FRAMETIME 100
...
gs_weapon_definition_t gs_weaponDefs[] =
{
...

	{
		...
		WEAP_GRENADELAUNCHER,
		{
			...
			1250,							// stun
			125,							// splash radius
			120,								// splash minimum damage
			40,                             // splash minimum knockback
...

	{
...

		{
			...
			//damages
			15,								// damage
			0.55,								// selfdamage ratio (lg cant damage)
			50,								// knockback
			300,							// stun
			0,								// splash radius
			0,								// splash minimum damage
