...
const float pm_accelerate = 18; // user intended acceleration when on ground or fly movement ( initially 10 )
...
const float pm_aircontrol = 1.0f; // aircontrol multiplier (intertia velocity to forward velocity conversion)
